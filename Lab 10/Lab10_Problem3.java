...
public class Lab10_Problem3
{
  public static void main(String[] args)
  {
    ...
    iArrayLength = dSals.length;
    
    DecimalFormat dfMain = new DecimalFormat("$#,#00.00");
    fvDisplay(dSals);
    dSum = fdSum(dSals);
    dMean=fdMean(dSum,iArrayLength);
    
    System.out.println("Total of 8 salaries: "+dfMain.format(dSum));
    if (dMean==-1)
    {
      return;
    }
    ...
    {
    System.out.println("Mean of 8 salaries: "+dfMain.format(dMean));
    }
  }
  ...
  public static double fdMean( double pdSum, int piArrayLength)
  {
    double dMean;
    ...
    {
      dMean = pdSum/(double)piArrayLength;
      return dMean;
